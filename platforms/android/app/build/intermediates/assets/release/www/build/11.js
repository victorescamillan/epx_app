...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__members__ = __webpack_require__(477);
...
var MembersPage = (function () {
    ...
    MembersPage.prototype.LoadMembers = function (refresher) {
        ...
        this.epxProvider.getMembers().subscribe(function (data) {
            ...
            if (refresher) {
                _this.cache.loadFromDelayedObservable(url, members, groupKey).subscribe(function (data) {
