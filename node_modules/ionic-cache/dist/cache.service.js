...
var CacheService = (function () {
    ...
    CacheService.prototype.resetDatabase = function () {
        var _this = this;
        return this.ready().then(function () { return _this._storage.clear(); });
    };
    /**
    ...
    CacheService.prototype.itemExists = function (key) {
        ...
        return this._storage.keys().then(function (keys) {
    ...
    CacheService.prototype.loadFromObservable = function (key, observable, groupKey, ttl) {
        ...
        return Observable.fromPromise(this.getItem(key)).catch(function (e) {
