...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vault__ = __webpack_require__(487);
...
var VaultPage = (function () {
    ...
    VaultPage.prototype.LoadVault = function (refresher) {
        ...
        this.epxProvider.getVault().subscribe(function (data) {
            ...
            if (refresher) {
                _this.vaultList = _this.cache.loadFromDelayedObservable(url, vault, groupKey);
