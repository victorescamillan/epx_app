...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__trips__ = __webpack_require__(485);
    ...
    TripsPage.prototype.LoadTrips = function (refresher) {
        ...
        this.epxProvider.getData('ID').then(function (user_id) {
            _this.epxProvider.getTrips(user_id).subscribe(function (data) {
                ...
                if (refresher) {
                    _this.cache.loadFromDelayedObservable(url, trips, groupKey).subscribe(function (data) {
