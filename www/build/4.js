...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__trip_details__ = __webpack_require__(483);
...
var TripDetailsPage = (function () {
    ...
    TripDetailsPage.prototype.ionViewWillUnload = function () {
    ...
    TripDetailsPage.prototype.loadTripDetails = function (id) {
        var _this = this;
        this.epxProvider.getData('trip_details').then(function (data) {
